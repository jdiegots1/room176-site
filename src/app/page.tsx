      ...
      >
        <div className="container">
          ...
          <article className="story story--myst">
            <p>Un proyecto independiente de simulación política en desarrollo. Construido paso a paso, con la comunidad, y con el foco en campañas, escaños y pactos.</p>
            <p>Ligero, serio y humilde: primero el fundamento, luego las palabras. Más, muy pronto.</p>
          </article>
